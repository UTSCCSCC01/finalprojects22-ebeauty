...
------------------react default readme starts here ------------------------
...
---------------------react default readme ends here-----------------------
### note: npm install would show 6 vulners. but according to this post, if I do some modification and then use `npm audit --production` instead of `npm audit`, it gives 0 vulner.
